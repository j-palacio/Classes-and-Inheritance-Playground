...
// Create an instance of Fighter called destroyer
let destroyer = Fighter(weapon: "Laser", remainingFirePower: 10)
destroyer.name = "Destroyer"

// Print the initial position of destroyer
print("Initial position: \(destroyer.position)")

// Call moveRight() and print position again
destroyer.moveRight()
print("New position after moving right: \(destroyer.position)")
...
// Trying to print weapon on falcon
// print(falcon.weapon)

// The above line doesn't compile because the Spaceship class does not have a weapon property. Only the Fighter class has the weapon property.
print("Error: The property 'weapon' does not exist on instances of the 'Spaceship' class. Only 'Fighter' instances have the 'weapon' property.")
