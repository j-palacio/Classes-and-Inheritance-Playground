...
// Define the ShieldedShip class inheriting from Fighter
class ShieldedShip: Fighter {
    var shieldStrength: Int
    
    init(name: String = "", weapon: String = "", remainingFirePower: Int = 5, shieldStrength: Int = 25) {
    ...
    override func wasHit() {
        ...
        print("Shield strength: \(shieldStrength)")
        print("Health: \(health)")
        }
}

// Create an instance of ShieldedShip called defender
let defender = ShieldedShip(name: "Defender", weapon: "Cannon")

// Call moveRight() and print position
defender.moveRight()
print("Position after moving right: \(defender.position)")

// Call fire() and print remainingFirePower
defender.fire()
print("Remaining fire power after firing: \(defender.remainingFirePower)")
